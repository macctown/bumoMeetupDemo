...
const contractAddr = "buQBRDM1oLUSSJgS5KgtRz2E58X31ubgKVhr";
var _winners = "";
...
var homeController = {
    ...
    deploy: function(req, res) {
        ...
        const creationOperation = async () => {
            ...
            initInput = "{\"params\":{\"lotteryName\":\"Mega Million 1\",\"ticketPrice\":\"2\"}}";
            ...
            if (transactionInfo.errorCode !== 0) {
                ...
                renderRes.render('retailer', {
                    title: 'BUMO Mega Million - Retailer',
                    contractTxn: true,
                    txn: JSON.stringify(transactionInfo.result.hash),
                    hasTxnInfo:false
                });
            }
        }
