...
function init(input_str) {
  ...
  assert(typeof params.lotteryName === 'string' && params.lotteryName.length > 0 && typeof params.ticketPrice === 'string' && int64Compare(params.ticketPrice, 0) === 1, 'Args check failed.');
